...
export const SettingsPresets = (node: INode<any>) => ChoiceNode([
  {
    type: 'string',
    node: EnumNode('dimension_generator_setting_preset', { search: true, additional: true, defaultValue: 'minecraft:overworld', validation: { validator: 'resource', params: { pool: COLLECTIONS.get('dimension_generator_setting_preset') } } })
  },
  {
    type: 'object',
    node,
